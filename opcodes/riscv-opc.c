...
{"sradd",     "Xscen",   "s,q(t)", MATCH_XSCEN_SRADD, MASK_XSCEN_SRADD, match_opcode, 0 },
{"sradd",     "Xscen",   "s,t",    MATCH_XSCEN_SRADD, MASK_XSCEN_SRADD | MASK_SIMM, match_opcode, INSN_ALIAS },
{"srdda",     "Xscen",   "q(s),t", MATCH_XSCEN_SRDDA, MASK_XSCEN_SRDDA, match_opcode, 0 },
{"srdda",     "Xscen",   "s,t",    MATCH_XSCEN_SRDDA, MASK_XSCEN_SRDDA | MASK_SIMM, match_opcode, INSN_ALIAS },
...
{"srdsub",    "Xscen",   "s,q(t)", MATCH_XSCEN_SRDSUB, MASK_XSCEN_SRDSUB, match_opcode, 0 },
{"srdsub",    "Xscen",   "s,t",    MATCH_XSCEN_SRDSUB, MASK_XSCEN_SRDSUB | MASK_SIMM, match_opcode, INSN_ALIAS },
